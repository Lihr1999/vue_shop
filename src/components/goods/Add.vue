    ...
    export default {
        ...
        methods: {
            ...
            handleSuccess(response) {
                ...
                // 2.把上传成功的文件/图片临时路径保存到addForm的pics数组中
            ...
            add() {
                ...
                this.$refs.addFormRef.validate(async valid => {
                    if (!valid) return this.$message.error('请填写比要的表单项')
                    // 执行添加的业务逻辑
                    // 如果直接对addForm的goods_cat进行转字符串操作，会报错，因为级联选择器的v-model需要是数组
                    ...
                    // 最终把addForm.attrs数组赋值给form对象(提交参数所用的对象)
